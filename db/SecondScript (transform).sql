...
CREATE TABLE TRANSFORM_INTERATION (
    ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);

CREATE TABLE CHANNELS_TRANSF
(
    ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE PROMOTIONS_TRANSF
(
    ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
