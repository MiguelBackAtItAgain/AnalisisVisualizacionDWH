CREATE DATABASE mmbsdbstg;

CREATE DATABASE mmbsdbstor;
...
CREATE TABLE COUNTRIES 
    ( 
     ...
     COUNTRY_REGION_ID VARCHAR(6)  NOT NULL 
    ) 
;
...
CREATE TABLE PRODUCTS 
    ( 
     ...
     PROD_WEIGHT_CLASS VARCHAR(4)  NOT NULL , 
     SUPPLIER_ID VARCHAR (10)  NOT NULL , 
     PROD_STATUS VARCHAR (20)  NOT NULL , 
     PROD_LIST_PRICE VARCHAR(12)  NOT NULL , 
     PROD_MIN_PRICE VARCHAR(12)  NOT NULL 
    )
;
...
CREATE TABLE PROMOTIONS 
    ( 
     ...
     PROMO_COST VARCHAR(15)  NOT NULL , 
     PROMO_BEGIN_DATE VARCHAR(6)  NOT NULL , 
     PROMO_END_DATE VARCHAR(6)  NOT NULL 
    )
;
...
CREATE TABLE TIMES 
    ( 
     ...
     DAY_INTEGER_IN_WEEK VARCHAR(2)  NOT NULL , 
     DAY_INTEGER_IN_MONTH VARCHAR(3)  NOT NULL , 
     CALENDAR_WEEK_INTEGER VARCHAR(4)  NOT NULL , 
     CALENDAR_MONTH_INTEGER VARCHAR(3)  NOT NULL , 
     CALENDAR_MONTH_DESC VARCHAR(8)  NOT NULL , 
     END_OF_CAL_MONTH VARCHAR(15)  NOT NULL , 
     CALENDAR_MONTH_NAME VARCHAR (9)  NOT NULL , 
     CALENDAR_QUARTER_DESC VARCHAR(7)  NOT NULL , 
