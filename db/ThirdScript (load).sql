...
ALTER TABLE
    CUSTOMERS
ADD
    CONSTRAINT CUSTOMERS_COUNTRY_FK FOREIGN KEY (COUNTRY_ID) REFERENCES COUNTRIES (ID);

ALTER TABLE
    SALES
ADD
    CONSTRAINT SALES_CHANNEL_FK FOREIGN KEY (CHANNEL_ID) REFERENCES CHANNELS (ID);

ALTER TABLE
    SALES
ADD
    CONSTRAINT SALES_CUSTOMER_FK FOREIGN KEY (CUST_ID) REFERENCES CUSTOMERS (ID);

ALTER TABLE
    SALES
ADD
    CONSTRAINT SALES_PRODUCT_FK FOREIGN KEY (PROD_ID) REFERENCES PRODUCTS (ID);

ALTER TABLE
    SALES
ADD
    CONSTRAINT SALES_PROMO_FK FOREIGN KEY (PROMO_ID) REFERENCES PROMOTIONS (ID);

ALTER TABLE
    SALES
ADD
    CONSTRAINT SALES_TIME_FK FOREIGN KEY (TIME_ID) REFERENCES TIMES (ID);